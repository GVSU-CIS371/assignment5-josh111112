 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const vf=-62135596800,Ef=1e6;class Ve{static now(){return Ve.fromMillis(Date.now())}static fromDate(e){return Ve.fromMillis(e.getTime())}static fromMillis(e){const t=Math.floor(e/1e3),r=Math.floor((e-1e3*t)*Ef);return new Ve(t,r)}constructor(e,t){if(this.seconds=e,this.nanoseconds=t,t<0)throw new K(k.INVALID_ARGUMENT,"Timestamp nanoseconds out of range: "+t);if(t>=1e9)throw new K(k.INVALID_ARGUMENT,"Timestamp nanoseconds out of range: "+t);if(e<vf)throw new K(k.INVALID_ARGUMENT,"Timestamp seconds out of range: "+e);if(e>=253402300800)throw new K(k.INVALID_ARGUMENT,"Timestamp seconds out of range: "+e)}toDate(){return new Date(this.toMillis())}toMillis(){return 1e3*this.seconds+this.nanoseconds/Ef}_compareTo(e){return this.seconds===e.seconds?ue(this.nanoseconds,e.nanoseconds):ue(this.seconds,e.seconds)}isEqual(e){return e.seconds===this.seconds&&e.nanoseconds===this.nanoseconds}toString(){return"Timestamp(seconds="+this.seconds+", nanoseconds="+this.nanoseconds+")"}toJSON(){return{type:Ve._jsonSchemaVersion,seconds:this.seconds,nanoseconds:this.nanoseconds}}static fromJSON(e){if(Ri(e,Ve._jsonSchema))return new Ve(e.seconds,e.nanoseconds)}valueOf(){const e=this.seconds-vf;return String(e).padStart(12,"0")+"."+String(this.nanoseconds).padStart(9,"0")}}Ve._jsonSchemaVersion="firestore/timestamp/1.0",Ve._jsonSchema={type:$e("string",Ve._jsonSchemaVersion),seconds:$e("number"),nanoseconds:$e("number")};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */$n(uS,hS,"app");const fS={apiKey:void 0,authDomain:void 0,projectId:void 0,storageBucket:void 0,messagingSenderId:void 0,appId:void 0},r_=qp(fS),xs=q0(r_),dc=Kw(r_),kr=(n,e)=>{const t=n.__vccOpts||n;for(const[r,s]of e)t[r]=s;return t},dS={},pS={class:"carafe"};function gS(n,e){return pe(),Pe("div",pS,[co(n.$slots,"top",{},void 0,!0),co(n.$slots,"mid",{},void 0,!0),co(n.$slots,"bottom",{},void 0,!0)])}const mS=kr(dS,[["render",gS],["__scopeId","data-v-8709b092"]]),_S={},yS={class:"mug"};function vS(n,e){return pe(),Pe("div",yS,[co(n.$slots,"default")])}const ES=kr(_S,[["render",vS]]),fd=["Hot","Cold"],gs=iE("BeverageStore",{state:()=>({user:null,unsubscribe:null,bases:[],creamers:[],syrups:[],temps:fd,currentTemp:fd[0],currentBase:null,currentCreamer:null,currentSyrup:null,currentBeverage:null,beverageName:"",beverages:[]}),actions:{async init(){const n=await fc(Os(xs,"bases"));this.bases=n.docs.map(r=>r.data());const e=await fc(Os(xs,"creamers"));this.creamers=e.docs.map(r=>r.data());const t=await fc(Os(xs,"syrups"));this.syrups=t.docs.map(r=>r.data()),this.bases.length>0&&(this.currentBase=this.bases[0]),this.creamers.length>0&&(this.currentCreamer=this.creamers[0]),this.syrups.length>0&&(this.currentSyrup=this.syrups[0])},setUser(n){if(this.user=n,this.unsubscribe&&(this.unsubscribe(),this.unsubscribe=null),n){const e=tS(Os(xs,"beverages"),nS("userId","==",n.uid));this.unsubscribe=aS(e,t=>{this.beverages=t.docs.map(r=>({id:r.id,...r.data()})),this.beverages.length>0?this.currentBeverage=this.beverages[this.beverages.length-1]:this.currentBeverage=null})}else this.beverages=[],this.currentBeverage=null},async makeBeverage(){if(!this.user)return"No user logged in, please sign in first.";if(!this.beverageName||!this.currentBase||!this.currentCreamer||!this.currentSyrup)return"Please complete all beverage options and the name before making a beverage.";const n={name:this.beverageName,temp:this.currentTemp,base:this.currentBase,syrup:this.currentSyrup,creamer:this.currentCreamer,userId:this.user.uid};try{return await oS(Os(xs,"beverages"),n),this.beverageName="",`Beverage ${n.name} made successfully!`}catch(e){return console.error("Failed to store beverage:",e),"Error making beverage."}},showBeverage(n){this.currentTemp=n.temp,this.currentBase=n.base,this.currentSyrup=n.syrup,this.currentCreamer=n.creamer,this.currentBeverage=n}},persist:!0}),TS=Ei({__name:"Syrup",setup(n){const e=gs();return(t,r)=>(pe(),Pe("div",{class:"syrup",style:vr({backgroundColor:_e(e).currentSyrup.color})},null,4))}}),IS=kr(TS,[["__scopeId","data-v-a84a438b"]]),wS=Ei({__name:"Base",setup(n){const e=gs();return(t,r)=>(pe(),Pe("div",{class:"baseBeverage",style:vr({backgroundColor:_e(e).currentBase.color})},null,4))}}),AS=kr(wS,[["__scopeId","data-v-a1c893a4"]]),bS=Ei({__name:"Creamer",setup(n){const e=gs();return(t,r)=>(pe(),Pe("div",{class:"froth",style:vr({backgroundColor:_e(e).currentCreamer.color})},[(pe(),Pe(Fe,null,On(5,s=>ke("div",{key:s,class:"foam",style:vr({backgroundColor:_e(e).currentCreamer.color})},null,4)),64))],4))}}),SS=kr(bS,[["__scopeId","data-v-74f0ed7a"]]),RS={},CS={id:"steam"},PS={class:"stream"};function VS(n,e){return pe(),Pe("div",CS,[(pe(),Pe(Fe,null,On(3,()=>ke("div",PS)),64))])}const kS=kr(RS,[["render",VS]]),DS={},NS={id:"condensation"},OS={class:"flake"};function xS(n,e){return pe(),Pe("div",NS,[(pe(),Pe(Fe,null,On(3,()=>ke("div",OS)),64))])}const MS=kr(DS,[["render",xS]]),LS=Ei({__name:"Beverage",props:{isIced:{type:Boolean}},setup(n){const e=gs();return(t,r)=>(pe(),xn(ES,null,{default:Ms(()=>[n.isIced?(pe(),xn(MS,{key:0})):(pe(),xn(kS,{key:1})),It(mS,null,{top:Ms(()=>[_e(e).currentCreamer.name!=="No Creamer"&&_e(e).currentCreamer.name!=="No Cream"?(pe(),xn(SS,{key:0})):Co("",!0)]),mid:Ms(()=>[_e(e).currentSyrup.name!=="No Syrup"?(pe(),xn(IS,{key:0})):Co("",!0)]),bottom:Ms(()=>[It(AS)]),_:1})]),_:1}))}}),FS={class:"auth-section",style:{"margin-bottom":"20px","text-align":"center",color:"white"}},US={style:{"margin-right":"15px"}},BS={key:2,style:{color:"yellow","margin-top":"10px"}},jS=["id","value"],$S=["id","value"],qS=["id","value"],HS=["id","value"],zS={style:{"text-align":"center","margin-top":"20px",color:"white"}},WS=["disabled"],KS={key:0,id:"beverage-container"},GS=["onClick"],QS=Ei({__name:"App",setup(n){const e=gs(),t=Bd(""),r=async()=>{const a=new hn;try{await nw(dc,a),t.value=""}catch(c){t.value=`Login Error: ${c.message}`}},s=async()=>{try{await MI(dc),t.value=""}catch(a){t.value=`Logout Error: ${a.message}`}},i=async()=>{const a=await e.makeBeverage();t.value=a||""};return Zd(()=>{xI(dc,a=>{e.setUser(a),a||(t.value="")})}),(a,c)=>(pe(),Pe("div",null,[ke("div",FS,[_e(e).user?(pe(),Pe(Fe,{key:1},[ke("span",US,"Welcome, "+kn(_e(e).user.displayName||_e(e).user.email),1),ke("button",{onClick:s},"Sign out")],64)):(pe(),Pe("button",{key:0,onClick:r},"Sign in with Google")),t.value?(pe(),Pe("p",BS,kn(t.value),1)):Co("",!0)]),It(LS,{isIced:_e(e).currentTemp==="Cold"},null,8,["isIced"]),ke("ul",null,[ke("li",null,[(pe(!0),Pe(Fe,null,On(_e(e).temps,l=>(pe(),Pe("label",{key:l},[Ds(ke("input",{type:"radio",name:"temperature",id:`r${l}`,value:l,"onUpdate:modelValue":c[0]||(c[0]=h=>_e(e).currentTemp=h)},null,8,jS),[[Zi,_e(e).currentTemp]]),Fs(" "+kn(l),1)]))),128))]),ke("li",null,[(pe(!0),Pe(Fe,null,On(_e(e).creamers,l=>(pe(),Pe("label",{key:l.id},[Ds(ke("input",{type:"radio",name:"creamer",id:`r${l.id}`,value:l,"onUpdate:modelValue":c[1]||(c[1]=h=>_e(e).currentCreamer=h)},null,8,$S),[[Zi,_e(e).currentCreamer]]),Fs(" "+kn(l.name),1)]))),128))]),ke("li",null,[(pe(!0),Pe(Fe,null,On(_e(e).syrups,l=>(pe(),Pe("label",{key:l.id},[Ds(ke("input",{type:"radio",name:"syrup",id:`r${l.id}`,value:l,"onUpdate:modelValue":c[2]||(c[2]=h=>_e(e).currentSyrup=h)},null,8,qS),[[Zi,_e(e).currentSyrup]]),Fs(" "+kn(l.name),1)]))),128))]),ke("li",null,[(pe(!0),Pe(Fe,null,On(_e(e).bases,l=>(pe(),Pe("label",{key:l.id},[Ds(ke("input",{type:"radio",name:"baseBeverage",id:`r${l.id}`,value:l,"onUpdate:modelValue":c[3]||(c[3]=h=>_e(e).currentBase=h)},null,8,HS),[[Zi,_e(e).currentBase]]),Fs(" "+kn(l.name),1)]))),128))])]),ke("div",zS,[c[5]||(c[5]=ke("label",{for:"beverage-name"},"Name ",-1)),Ds(ke("input",{id:"beverage-name","onUpdate:modelValue":c[4]||(c[4]=l=>_e(e).beverageName=l),type:"text"},null,512),[[Wv,_e(e).beverageName]]),ke("button",{onClick:i,disabled:!_e(e).user,style:{"margin-left":"10px"}}," Make Beverage ",8,WS)]),_e(e).user&&_e(e).beverages.length>0?(pe(),Pe("div",KS,[c[6]||(c[6]=ke("h3",null,"Saved Beverages",-1)),ke("ul",null,[(pe(!0),Pe(Fe,null,On(_e(e).beverages,l=>(pe(),Pe("li",{key:l.id},[ke("button",{onClick:h=>_e(e).showBeverage(l)},kn(l.name),9,GS)]))),128))])])):Co("",!0)]))}}),s_=Zv();s_.use(uE);const i_=Jv(QS);i_.use(s_);async function JS(){await gs().init(),i_.mount("#app")}JS();
